...
Revision ID: e077bd5c1e0e
Revises: 
Create Date: 2026-06-09 09:41:08.197828
...
def upgrade() -> None:
    ...
    sa.Column('permissoes', sa.String(length=255), nullable=False, server_default=''),
